  ...
  <div class='col-lg-10'>
    <div class='form-group col-lg-10'>
     ...
     <div class='form-group'>
      <div class='col-sm-9'>
        <div class='progress'>
          <div class='progress-bar progress-bar-striped' id='progress".$i."' style='width: ".$ligne['progression']."%'>".$ligne['progression']."%</div>
        </div></div></div>
        <div class='form-group'>
          <label  class='col-sm-4 control-label' >editer la progression </label>
          <div class='col-xs-4'> <input type='number' id='value".$i."' onchange='changeValue(\"progress".$i."\", \"value".$i."\", ".$ligne['id_tache'].");' min='0'max='100' class='form control' value='".$ligne['progression']."'>
          </div>
        </div>
      </div>
