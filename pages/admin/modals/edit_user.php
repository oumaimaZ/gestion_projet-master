  ...
  <div class="modal-dialog modal-lg">
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h3 class="modal-title">editer</h3>
      </div>
                    ...
                    <div class="panel-body">
                      <div class="col-xs-8.col-sm-6">
                                ...
                                <div class="panel panel-default">
                                          ...
                                          <div class="panel-body">
                                                  <div class="checkbox">
                                                    <label><input type="checkbox" name='document[]' id='document2'value="2"  unchecked>creer</label>
                                                  </div>

                                                  <div class="checkbox">
                                                    <label><input type="checkbox"name='document[]'id='document3' value="3"  unchecked>consulter</label>
                                                  </div>
                                                  <div class="checkbox">
                                                    <label><input type="checkbox"name='document[]'id='document4' value="4" unchecked>supprimer</label>
                                                  </div>
                                                  <div class="checkbox">
                                                    <label><input type="checkbox"name='document[]' id='document5'value="5" unchecked>editer</label>
                                                  </div>
                                          </div>
                                          <script>
                                             ...
                                             $('#document1').change(function(){
                                                if($("#document1").is(":checked")) {
                                                  $('#document2').attr("checked",true);
                                                   $('#document3').attr("checked",true);
                                                    $('#document4').attr("checked",true);
                                                     $('#document5').attr("checked",true);
                                                }
                                                else{
                                                  $('#document2').attr("checked",false);
                                                   $('#document3').attr("checked",false);
                                                    $('#document4').attr("checked",false);
                                                     $('#document5').attr("checked",false);
