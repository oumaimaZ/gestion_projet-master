              ...
              <div class="col-xs-8.col-sm-6">
                ...
                <div class="col-xs-4">
                  <div class="panel panel-default">
                    ...
                    <div class="panel-heading">
                    <input type='checkbox' id='edit_projet1' value="1"> Projets</div>
                      <div class="panel-body">
                        <div class="checkbox">
                        <label><input type="checkbox" name='edit_projet[]' id='edit_projet2' value="1">creer</label>
                        </div>
                        <div class="checkbox">
                        <label><input type="checkbox" name='edit_projet[]' id='edit_projet3' value="2">consulter</label>
                        </div>
                        <div class="checkbox">
                        <label><input type="checkbox" name='edit_projet[]' id='edit_projet4' value="3">supprimer</label>
                        </div>
                        <div class="checkbox">
                        <label><input type="checkbox" name='edit_projet[]' id='edit_projet5' value="4">editer</label>
                        </div>
                      </div>
                      <script>

                      $('#edit_projet1').change(function(){
                        if($("#edit_projet1").is(":checked")) {
                          document.getElementById('edit_projet2').checked = true;
                          document.getElementById('edit_projet3').checked = true;
                          document.getElementById('edit_projet4').checked = true;
                          document.getElementById('edit_projet5').checked = true;
                        }
                        else{
                          document.getElementById('edit_projet2').checked = false;
                          document.getElementById('edit_projet3').checked = false;
                          document.getElementById('edit_projet4').checked = false;
                          document.getElementById('edit_projet5').checked = false;
