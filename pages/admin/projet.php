...
if (isset($_POST['modifier'])){
  ...
  $user=$_SESSION['id_user'];
                             $sql = 'SELECT p.*,p.username as proprietaire,B.nbm  ,C.nbd,B.username as membre,(sum(E.progression)/D.nbt) as statut,D.nbt
                                        FROM `projet`p ,(SELECT `id_projet`,count(`username`) as nbm, `username` 
                                                        ...
                                                        group by `id_projet`)as E,
                                                          (select username from user)as f
                ...
                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                  ...
                  <tbody>
                    ...
                    while($ligne = $query->fetch())
                    {
                      ...
                      if($ligne['membre'] == $_SESSION['username']) $profil= 'membre';
                       else if($ligne['proprietaire'] == $_SESSION['username']) $profil= 'proprietaire';
                      echo "<tr>";
