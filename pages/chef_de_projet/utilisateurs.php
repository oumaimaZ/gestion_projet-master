...
if(isset($_POST['delete'])){
  $id=$_SESSION["id_user"];
         $sql = 'SELECT `username`, `service-division`, `direction`, `telephone`, `email`,p.titre
                   from user_projet r,projet p ,user u ,(SELECT id_projet from user_projet
                                                         where id_user=$id)as A
...
$id=$_SESSION["id_user"];
  $sql = 'SELECT `username`, `service-division`, `direction`, `telephone`, `email`,p.titre,id_user
   from user_projet r,projet p ,user u ,(SELECT id_projet from user_projet
                                         where id_user="$id")as A
   where r.`id_user`=u.`id_user` 
   and p.id_projet=r.id_projet 
